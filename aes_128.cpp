...
void AES_128::SetKey(unsigned char* key) {
    KeyExpansion(key);
}
...
void AES_128::KeyExpansion(unsigned char* key) {
    int i, j, r, c;
    for (r = 0; r < 4; r++) {
        for (c = 0; c < 4; c++) {
            w[0][r][c] = key[r + c * 4];
...
unsigned char AES_128::FFmul(unsigned char a, unsigned char b) {
    unsigned char bw[4];
    unsigned char res = 0;
    int i;
    bw[0] = b;
...
void AES_128::SubBytes(unsigned char state[][4]) {
    int r, c;
    for (r = 0; r < 4; r++) {
        for (c = 0; c < 4; c++) {
...
void AES_128::ShiftRows(unsigned char state[][4]) {
    unsigned char t[4];
    int r, c;
    for (r = 1; r < 4; r++) {
        for (c = 0; c < 4; c++) {
...
void AES_128::MixColumns(unsigned char state[][4]) {
    unsigned char t[4];
    int r, c;
    for (c = 0; c < 4; c++) {
        for (r = 0; r < 4; r++) {
...
void AES_128::AddRoundKey(unsigned char state[][4], unsigned char k[][4]) {
    int r, c;
    for (c = 0; c < 4; c++) {
        for (r = 0; r < 4; r++) {
            state[r][c] ^= k[r][c];
...
void AES_128::InvSubBytes(unsigned char state[][4]) {
    int r, c;
    for (r = 0; r < 4; r++) {
        for (c = 0; c < 4; c++) {
...
void AES_128::InvShiftRows(unsigned char state[][4]) {
    unsigned char t[4];
    int r, c;
    for (r = 1; r < 4; r++) {
        for (c = 0; c < 4; c++) {
...
void AES_128::InvMixColumns(unsigned char state[][4]) {
    unsigned char t[4];
    int r, c;
    for (c = 0; c < 4; c++) {
        for (r = 0; r < 4; r++) {
